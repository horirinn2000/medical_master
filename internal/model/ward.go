...
type Ward struct {
	...
	FacilityStandardCategory       string  `csv:"44" json:"facility_standard_category"`        // 44: 適合区分
	FacilityStandardCode           string  `csv:"45" json:"facility_standard_code"`            // 45: 対象施設基準
	...
	EndoscopicSurgeryAddition      string  `csv:"64" json:"endoscopic_surgery_addition"`       // 64: 超音波内視鏡検査加算区分
